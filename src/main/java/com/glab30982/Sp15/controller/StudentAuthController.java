package com.glab30982.Sp15.controller;
...
public class StudentAuthController {
    ...
    // handler methods handles the login request
        @GetMapping("/login")
        public String login(){
            return "login";
        }
    ...
    public String registration(@Valid @ModelAttribute("student")
            ...
            if (existingStudent != null && existingStudent.getEmail() !=
            null && !existingStudent.getEmail().isEmpty()){
